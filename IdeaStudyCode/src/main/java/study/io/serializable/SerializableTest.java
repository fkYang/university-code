...
public class SerializableTest {
    public static void main(String[] args) throws Exception {
        FileOutputStream fos = new FileOutputStream("D:\\31577\\桌面\\javaFile\\temp.out");
        ...
        FileInputStream fis = new FileInputStream("D:\\31577\\桌面\\javaFile\\temp.out");
